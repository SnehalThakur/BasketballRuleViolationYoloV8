...
cap = cv2.VideoCapture(r'data/basketballViolation-Travel.mp4')
...
while cap.isOpened():
    ...
    if success:
        ...
        try:
            ...
            left_knee = rounded_results[0].data[0][body_index["left_knee"]]
            right_knee = rounded_results[0].data[0][body_index["right_knee"]]
            left_ankle = rounded_results[0].data[0][body_index["left_ankle"]]
            right_ankle = rounded_results[0].data[0][body_index["right_ankle"]]
        ...
        cv2.imshow("AI Basketball Referee - Travel Detection", combined_frame)
